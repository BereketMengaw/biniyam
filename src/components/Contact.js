...
const socials = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/binyam-b-35666b279/',
    icon: (
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/wushicho/',
    icon: (
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@biniambilliso8390',
    icon: (
